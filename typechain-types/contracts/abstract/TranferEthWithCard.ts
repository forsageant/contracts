...
export interface TranferEthWithCardInterface extends utils.Interface {
  functions: {
    "card()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "card"): FunctionFragment;
...
export interface TranferEthWithCard extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TranferEthWithCardInterface;
