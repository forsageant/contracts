...
export interface CardNFTInterface extends utils.Interface {
  functions: {
...
export interface CardNFT extends BaseContract {
  ...
  functions: {
    ...
    setBaseUrl(
      _baseUrl: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
